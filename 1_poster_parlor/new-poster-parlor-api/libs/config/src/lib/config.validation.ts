...
import { ArrayNotEmpty, IsArray, IsEnum, IsNotEmpty, IsNumber, IsString, Matches, Max, Min, NotEquals, ValidateIf, validateSync, ValidationError, } from 'class-validator';
